...
let option = {
    ...
    xAxis : [
        {
            type : 'category',
            data : ['201901', '201902', '201903', '201904', '201905', '201906', '201907', '201906', '201908','201909'],
        }
    ],
    yAxis : [
        {
    ...
    series : [
        {
            ...
            data:[
            	 30,20,70,60,23,38,93,36,35,37,30,20,70,69,23,35,87,12,34,50,,38,93,36,35,37
            ]
        },
        {
            name:'红色预警',
		...
		barCateGoryGap:50,
            ...
            data:[
                10,20,70,69,23,88,90,56,35,87,12,34,55,77,22,55,11,8,19,3,,35,87,12,34,50,
            ]
        },
		  {
            name:'预警百分比',
            ...
            yAxisIndex: 1,
            data:[
                40,  20, 40, 80 ,88,35,22,55,36,60,30,90
            ],
             itemStyle: {        // 系列级个性化样式，纵向渐变填充
                normal: {
                   color : 'green',
