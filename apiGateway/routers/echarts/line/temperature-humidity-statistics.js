    ...
    series : [
        {
            name:'最高温度',
            type:'line',
            data:[80,20,40,10,30,40,70,80,3, 4, 50,60,80,90,20,10, 10,60,80,90,]
        },
      	{
            name:'平均温度',
            type:'line',
            data:[10,20,30,40,10,20,30,40,10,20,30,40,10,20,30,40,10,20,30,40]
        },
      	{
            name:'最低温度',
            type:'line',
            data:[1,2,2,5,-1,-3,2,4,5,1,2,3,6,7,8,2,2,5,-1,-3,2,4,5,1,2,3,6,7,8]
        },
       {
            name:'最高湿度',
            type:'line',
         	yAxisIndex: 1,
            data:[20,50,20,40,60,80,90,20,10, 10, 20, 5, 30, 1,22,12,25,4,13,23]
        },
       {
            name:'平均湿度',
            type:'line',
         	yAxisIndex: 1,
            data:[10,12,11,6,18,19,10,12,11,6,18,19,10,12,11,6,18,19,10,12,11]
        },
       {
            name:'最低湿度',
            type:'line',
         	yAxisIndex: 1,
            data:[5,6,8,9,1,2,3,6,7,5,6,8,9,1,2,3,6,7,5,6,8,9,1,2,3,6,7,5,6,8,9,1,2,3]
        }
    ]
};
