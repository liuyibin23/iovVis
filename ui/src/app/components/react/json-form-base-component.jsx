...
export default beidouappBaseComponent => class extends React.Component {
    ...
    render() {
        if (this.props.form && this.props.form.schema) {
            return <beidouappBaseComponent {...this.props} {...this.state} onChangeValidate={this.onChangeValidate}/>;
        } else {
            return <div></div>;
        }
    }
